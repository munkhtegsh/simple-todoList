You will write a set of classes to support a course registration system. For this and all projects, you are strongly encouraged to work in groups of up to four students. 
